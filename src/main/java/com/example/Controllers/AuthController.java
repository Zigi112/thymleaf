...
public class AuthController {
	...
	@PostMapping("/signup")
	public String processSignup(@RequestParam String email, @RequestParam String password, @RequestParam String name,
			Model model) {
	...
	public String processContacter(@RequestParam String email, @RequestParam String telephone, @RequestParam String nom,
			@RequestParam String prenom, @RequestParam String message, Model model) {
		System.out.println("!!!");
	...
	public String processEvent(@RequestParam String eventname, @RequestParam String eventdate,
			@RequestParam String eventtime, @RequestParam int participantsnbr, Model model) {
